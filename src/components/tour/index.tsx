      ...
      steps: [
        ...
        },
        {
          ...
          popover: {
            ...
            description:
              'If the file already exists in the repository, you can synchronize any changes by pulling from the repository with this button. Keep in mind that all local changes will be overwritten!',
          },
        },
      ],
    })
